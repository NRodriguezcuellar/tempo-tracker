 ...
 */
function startTracking(params: z.infer<typeof startTrackingSchema>): Session {
 ...
 */
function stopTracking(params: z.infer<typeof stopTrackingSchema>): Session | null {
      ...
      try {
        ...
        switch (data.command) {
          case 'start':
            ...
            result = startTracking(startParams);
            break;
